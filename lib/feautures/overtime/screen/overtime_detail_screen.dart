...
final String leaveDate = leaveData['lembur_tgl'] ?? 'N/A';
final String startDate = leaveData['lembur_jam_mulai'] ?? 'N/A';
final String endDate = leaveData['lembur_jam_selesai'] ?? 'N/A';
final String reason = leaveData['lembur_keterangan'] ?? '-';
final String status = leaveData['lembur_status'] ?? 'n';
final String fileUrl = leaveData['lembur_file'] ?? '';
