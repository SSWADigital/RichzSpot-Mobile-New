...
class AbsenResponse {
  ...
  factory AbsenResponse.fromJsonCekAbsen(Map<String, dynamic> json) {
    return AbsenResponse(
      status: true, // Assuming a successful response always has status true for cekAbsen
      message: 'Success', // You might want to add a message from the API if available
      absenId: json['absen_id'] ?? '-',
      checkin: json['checkin'] ?? '-',
      checkout: json['checkout'] ?? '-',
      data: json, // The entire JSON can be the data
    );
  }
